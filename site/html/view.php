        ...
        <li class="nav-item dropdown no-arrow">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
              ...
              if($_POST['userid']== 0){
                 ...
                 echo('<a class="dropdown-item" href="add-edit-user.php">Nouvel utilisateur</a>');
                 echo('<div class="dropdown-divider"></div>');
              }
              ?>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  foreach ($data as $row) {
                      ...
                      echo('<td><a class="dropdown-item" href="read-write-message.php">Répondre</a></td>');
                      echo('<td><a class="dropdown-item" href="#">Supprimer</a></td>');
                      echo('<td><a class="dropdown-item" href="read-write-message.php">Détails</a></td>');
                      echo "<tr/>";
                  }
                  ?>
